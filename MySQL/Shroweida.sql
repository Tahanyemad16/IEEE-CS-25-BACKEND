...
create database Sharwida2 ;-- cuz i'm a little bit stubid i made all ids idintity this will make me face some problems in query problem i will not find what the query want
-- i can write the correct query but it will not retrieve any data
use Sharwida2;
